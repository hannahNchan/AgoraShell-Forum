...
import { selectIsAdmin } from '../../auth/store/authSelectors'
          ...
          <div className="flex items-center justify-between gap-6">
            <div>
              <div className="flex items-center gap-2 mb-0.5">
                ...
                <span className="text-sm font-medium text-slate-700">Tags máximos por tema</span>
              </div>
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              <input
                ...
                className="w-20 border border-slate-200 rounded-lg px-3 py-2 text-sm text-center focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              <button

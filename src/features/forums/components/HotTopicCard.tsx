...
const HotTopicCard = ({ topic, rank }: { topic: HotTopic; rank: number }) => (
  <Link
    ...
    className="flex items-start gap-4 p-4 bg-white dark:bg-slate-900 dark:border-slate-500 rounded-xl border border-slate-100 hover:border-indigo-200 hover:shadow-sm transition-all group"
  >
    ...
    <div className="flex-1 min-w-0">
      ...
      <p className="text-sm font-semibold text-slate-800 dark:text-slate-400 leading-snug truncate dark:group-hover:text-slate-500 group-hover:text-indigo-600 transition-colors">
        {topic.title}
      </p>
